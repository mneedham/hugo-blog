...
I hadn't following https://clickhouse.com/docs/en/operations/access-rights[these instructions from the documentation^]:
...
[source, xml]
----
include::content/2023/11/07/server/folders.xml[]
----

.config.d/users.xml
[source, xml]
----
include::content/2023/11/07/server/users.xml[]
----
