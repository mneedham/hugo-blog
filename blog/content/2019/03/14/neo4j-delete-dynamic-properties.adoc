...
Irfan and I were playing with a dataset earlier today, and having run a bunch of https://neo4j.com/docs/graph-algorithms/current/[graph algorithms^], we had a lot of properties that we wanted to clear out.
