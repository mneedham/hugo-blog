...
We can do this by computing equally spaced lat/long coordinates in between the points that we do have using the Pyproj library.
...
We'll have the `npts` function compute two points in between the provided points:
